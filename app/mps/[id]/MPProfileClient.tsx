              ...
              return (
                <button
                  ...
                  className={
                    ...
                    (active
                      ? 'text-white bg-[#111827] border-l-[#4a7a3a] font-semibold'
              ...
              <div className="space-y-px bg-[#1a2e1a] border border-[#1a2e1a]">
                    ...
                    <div className="space-y-1">
                      ...
                      {contact.email && (
                        <p className="text-gray-200">
                          ...
                          <a href={'mailto:' + contact.email} className="text-[#4a7a3a] hover:underline break-all">
                            {contact.email}
                          </a>
                        </p>
                      )}
                ...
                {contact.website && (
                  <Card title="Website" partyColour={partyColour}>
                    <a href={contact.website} target="_blank" rel="noopener noreferrer" className="text-[#4a7a3a] hover:underline text-[13px] break-all">
                      {contact.website}
                    </a>
                  </Card>
                )}
                {contact.twitter && (
                  <Card title="X (formerly Twitter)" partyColour={partyColour}>
                    <a href={contact.twitter} target="_blank" rel="noopener noreferrer" className="text-[#4a7a3a] hover:underline text-[13px] break-all">
                      {contact.twitter}
                    </a>
                  </Card>
                )}
