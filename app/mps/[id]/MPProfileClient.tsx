                    ...
                    <div className="space-y-1">
                      {contact.phone && (
                        <p className="text-[#7697a2]">
                          <span className="text-[10px] uppercase tracking-[0.25em] text-[#7697a2] mr-2">Phone</span>
              ...
              <div className="space-y-px bg-[#1c3849] border border-[#1c3849]">
                {representations.map((rep: any, idx: number) => (
                  <Card key={idx} title={rep.name} partyColour={partyColour}>
                    ...
                    {rep.additionalInfo && <p className="text-[13px] text-[#7697a2] mt-2 leading-[1.7]">{rep.additionalInfo}</p>}
                  </Card>
                ))}
              </div>
            ) : (
                ...
                {votes.slice(0, 20).map((vote: any) => (
                  ...
                  >
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[11px] text-[#7697a2] font-mono">
                  ...
                  <li key={bill.id} className="bg-[#1c3849]">
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 text-[11px]">
                        <span className="text-[#7697a2] font-mono uppercase tracking-[0.15em]">{bill.current_stage || 'Unknown'}</span>
                    ...
                    <ul className="space-y-px bg-[#1c3849] border border-[#1c3849]">
                      {interestsByCategory[categoryName].map((interest: any) => (
                        <li key={interest.id} className="bg-[#1c3849] p-4 border-l-2" style={{ borderLeftColor: partyColour }}>
                          ...
                          <p className="text-[11px] text-[#7697a2] mt-2 font-mono">
...
function Empty({ children }: { children: React.ReactNode }) {
  return <p className="text-[#7697a2] text-[13px] leading-[1.7]">{children}</p>
}
