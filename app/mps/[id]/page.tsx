  ...
  return (
    <div className="min-h-screen bg-[#0a140a]">
      ...
      <main className="max-w-7xl mx-auto px-6 py-6">
        ...
        <div className="rounded-xl overflow-hidden mb-6 relative" style={{ background: `linear-gradient(135deg, ${partyColour}33 0%, #0a140a 60%)`, border: `1px solid ${partyColour}40` }}>
