...
const HOTSPOTS: Hotspot[] = [
  ...
  // Nav row (~14.6% down, full-width spread calibrated from the rendered debug)
  { href: '/', label: 'Home', left: 5, top: 14.6, width: 6, height: 2.4 },
  { href: '/bills', label: 'Bills', left: 13.25, top: 14.6, width: 5.5, height: 2.4 },
  { href: '/polls', label: 'Peoples Polls', left: 21.25, top: 14.6, width: 9.5, height: 2.4 },
  { href: '/parties', label: 'Parties', left: 34.75, top: 14.6, width: 6.5, height: 2.4 },
  { href: '/mps', label: 'MPs', left: 43.25, top: 14.6, width: 5.5, height: 2.4 },
  { href: '/departments', label: 'Departments', left: 50.25, top: 14.6, width: 9.5, height: 2.4 },
  { href: '/editorials', label: 'Editorials', left: 62.5, top: 14.6, width: 9, height: 2.4 },
  { href: '/transparency', label: 'Transparency', left: 74, top: 14.6, width: 10, height: 2.4 },
  { href: '/support', label: 'Support Us', left: 85.5, top: 14.6, width: 9, height: 2.4 },
];
