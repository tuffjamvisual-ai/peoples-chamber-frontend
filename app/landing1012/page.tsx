...
// /landing1012 — OPEN GOVERNMENT landing page built entirely in HTML/CSS on a
// blank parchment texture. Masthead + nav are REAL text (legible, clickable,
// responsive, with CSS-only dropdowns) instead of painted into an image with
// overlaid hotspots. The 10 homepage cards sit in a responsive grid. noindex.
