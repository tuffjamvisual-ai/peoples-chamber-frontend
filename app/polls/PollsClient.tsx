    ...
    <main className="max-w-7xl mx-auto px-4 sm:px-6 pb-12">
      ...
      <div className="flex items-center gap-3 mb-4">
        <input
          ...
          className="flex-1 px-4 py-2 bg-gray-800 text-white rounded border border-gray-700 focus:border-[#a8ff3e] focus:outline-none text-sm"
        />
        <select
          value={sort}
      ...
      {loading ? (
        <div className="text-center py-12">
          <div className="animate-spin rounded-full h-10 w-10 border-t-2 border-b-2 border-[#a8ff3e] mx-auto"></div>
        </div>
      ) : (
