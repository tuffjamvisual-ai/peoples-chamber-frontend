  ...
  return (
    <div className="min-h-screen bg-[#111111] text-white p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-[#cccccc] mb-4">Last updated: March 28, 2026</p>
        
        <h2 className="text-xl font-bold mt-6 mb-3">Information We Collect</h2>
        <p className="text-[#cccccc] mb-4">People's Chamber collects minimal personal information:</p>
        <ul className="list-disc list-inside text-[#cccccc] mb-4 space-y-2">
        ...
        <p className="text-[#cccccc] mb-4">Your information is used to:</p>
        <ul className="list-disc list-inside text-[#cccccc] mb-4 space-y-2">
