...
export default async function AssociationPage({ params }: PageProps) {
  ...
  return (
    <DossierShell>
      <BackLink fallbackHref="/donations/constituencies" label="← All constituencies" className="no-hover-scale" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', marginTop: '-6%', marginBottom: '12px', color: INK, textDecoration: 'none', fontSize: 'clamp(18px, 2.2vw, 28px)', transform: 'rotate(-0.2deg)' }} />
