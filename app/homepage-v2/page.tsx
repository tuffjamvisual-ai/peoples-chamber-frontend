...
// HTML/CSS so the page is responsive on mobile. Same cards, headlines and
// links as app/page.tsx; the only change is image overlay -> CSS grid.
// noindex while it lives alongside the live homepage.
...
// Top navigation, mirroring the masthead hotspots in DossierShell. Kept local
// to this preview so the live shell is untouched; lift to a shared module on
// adoption.
...
// Weekly issue line. Same anchor + arithmetic as DossierShell.computeIssue
// (Issue 23 = week beginning Fri 16 May 2025; Fri–Thu weeks).
  ...
  return (
    <div className="np">
      ...
      <header className="np-masthead">
        <div className="np-issueline">
          <span>Issue {issue}</span>
          <span>{dateRange}</span>
        </div>
        <h1 className="np-title">The People&rsquo;s Chamber</h1>
        <div className="np-tagline">An independent record of how the United Kingdom is governed</div>
        <div className="np-rule-double" aria-hidden />
      </header>
      ...
      {/* ── Lead area: wide left column + narrow right rail ── */}
