      ...
      <div className="page-shell">
        ...
        <section className="hero-section">
          ...
          <article className="office-scene" aria-label="Whitehall office scene">
            ...
            <div className="green-lamp">
              <span />
            </div>

            <div className="red-folder">Cabinet Office Briefing Notes</div>
            <div className="tea-cup">Keeping Britain Briefed</div>
            <div className="rubber-stamp" />

            <div className="memo memo-one">Official line</div>
            <div className="memo memo-two">Public record</div>
            <div className="memo memo-three">Urgent, apparently</div>
            <div className="memo memo-four">Not for clarification</div>
          </article>
