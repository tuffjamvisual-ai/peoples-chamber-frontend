...
const hotspots: Hotspot[] = [
  { href: '/',           label: "Home: The People's Chamber masthead",                 left: 21.5, top: 3.2,  width: 53.5, height: 22.5 },
  ...
  { href: '/join',       label: 'Join The People’s Chamber',                      left: 19.0, top: 94.5, width: 67.5, height: 3.2 },
];
  ...
  return (
    <main className="newspaper-stage">
      <div
        ...
        aria-label="The People's Chamber clickable newspaper landing page"
      >
        {hotspots.map((h) => (
          <Link
            key={h.label}
