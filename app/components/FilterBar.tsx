    ...
    <div className="mb-6">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <button
          ...
          className={'px-3 py-2 text-sm rounded transition-colors ' + (parliamentVoted ? 'bg-[#ffffff] text-white' : 'bg-[#222222] text-[#c9c9c9] hover:bg-[#222222]')}
        >
          Parliament Voted
        </button>
        <button
          onClick={() => setYouVoted(!youVoted)}
          className={'px-3 py-2 text-sm rounded transition-colors ' + (youVoted ? 'bg-[#ffffff] text-white' : 'bg-[#222222] text-[#c9c9c9] hover:bg-[#222222]')}
        >
          You Voted
        </button>
        <input
          ...
          style={{width: '340px'}}
          className="px-4 py-2 bg-[#222222] text-white rounded border border-[#333333] focus:border-[#ffffff] focus:outline-none text-sm"
        />
      </div>
    </div>
  );
