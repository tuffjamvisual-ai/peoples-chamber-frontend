    ...
    <div className="mb-6">
      <div className="flex flex-wrap gap-3 mb-3">
        <select
          ...
          className="px-3 py-2 bg-gray-800 text-white text-sm rounded border border-gray-700 focus:border-[#a8ff3e] focus:outline-none"
        >
      ...
      <div className="flex flex-wrap items-center gap-3">
        <button
          ...
          className={'px-3 py-2 text-xs rounded transition-colors ' + (parliamentVoted ? 'bg-[#a8ff3e] text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600')}
        >
          Parliament Voted
        </button>
        <button
          onClick={() => setYouVoted(!youVoted)}
          className={'px-3 py-2 text-xs rounded transition-colors ' + (youVoted ? 'bg-[#a8ff3e] text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600')}
        >
          You Voted
        </button>
        <input
          ...
          style={{width: '340px'}}
          className="px-4 py-2 bg-gray-800 text-white rounded border border-gray-700 focus:border-[#a8ff3e] focus:outline-none text-sm"
        />
      </div>
    </div>
  );
