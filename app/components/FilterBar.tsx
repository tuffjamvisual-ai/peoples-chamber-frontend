    ...
    <div className="mb-6">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <button
          ...
          className={'px-3 py-2 text-sm rounded transition-colors ' + (parliamentVoted ? 'bg-[#ffffff] text-white' : 'bg-[#404040] text-[#c9c9c9] hover:bg-[#404040]')}
        >
          Parliament Voted
        </button>
        <button
          onClick={() => setYouVoted(!youVoted)}
          className={'px-3 py-2 text-sm rounded transition-colors ' + (youVoted ? 'bg-[#ffffff] text-white' : 'bg-[#404040] text-[#c9c9c9] hover:bg-[#404040]')}
        >
          You Voted
        </button>
        <input
          ...
          style={{width: '340px'}}
          className="px-4 py-2 bg-[#404040] text-white rounded border border-[#5a5a5a] focus:border-[#ffffff] focus:outline-none text-sm"
        />
      </div>
    </div>
  );
