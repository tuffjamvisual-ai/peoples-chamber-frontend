                  ...
                  {user && user.id === comment.userId && (
                    <div className="flex gap-2">
                      <button
                        ...
                        className="text-xs text-[#4a7a3a] hover:text-[#4a7a3a]"
                      >
                        Edit
                      </button>
                      <button
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="px-3 py-1 bg-[#4a7a3a] hover:bg-[#4d7a22] text-white text-xs rounded"
                      >
                        Save
                      </button>
                      <button
          ...
          <div className="p-4 border-t border-gray-800">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <textarea
                ...
                className="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-3 py-2 text-white placeholder-gray-500 text-sm resize-none focus:outline-none focus:border-[#4a7a3a]"
                rows={3}
              />
              <button
                type="submit"
                disabled={loading || !newComment.trim()}
                className="w-full bg-[#4a7a3a] hover:bg-[#4d7a22] text-white py-2 rounded-lg text-sm font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
