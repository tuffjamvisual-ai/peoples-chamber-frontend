...
export default function BillsGridMobile({ initialBills }: Props) {
  ...
  return (
    <>
      <div className="sticky top-24 z-40 bg-[#0a0f1a] px-4 py-3 border-b border-gray-800">
        <input
          type="text"
      ...
      <div className="sticky top-[148px] z-40 bg-[#0a0f1a] border-b border-gray-800 overflow-x-auto">
