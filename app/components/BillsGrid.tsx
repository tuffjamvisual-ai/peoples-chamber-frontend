    ...
    <>
        ...
        {paginatedBills.map((bill: any) => {
          ...
          return (
            <div
              ...
              className="bg-gray-900 border border-gray-800 rounded-lg p-4 cursor-pointer hover:border-[#6b9e3e] transition-colors"
            >
      ...
      {paginatedBills.length > 0 && totalPages > 1 && (
        <div className="flex items-center justify-center gap-2">
          ...
          <div className="px-4 py-1.5 bg-[#6b9e3e] text-white rounded text-sm font-medium">{currentPage} / {totalPages}</div>
