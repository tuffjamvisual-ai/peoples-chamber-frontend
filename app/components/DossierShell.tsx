...
export default function DossierShell({
  ...
  // Horizontal padding of the folder content area. Defaults to 11%; MP
  // profile pages pass a smaller value to use more of the folder width.
