...
import "./magazine-shell.css";

type MagazineShellProps = {
  children: ReactNode;
  // The nav `is-active` underline. Pass the href that matches the current
  // page (e.g. "/" on the landing page) to highlight that nav item.
  activeHref?: string;
};
...
export default function MagazineShell({ children, activeHref = "/" }: MagazineShellProps) {
  return (
