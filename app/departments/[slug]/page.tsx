              ...
              <div className="flex gap-1.5 flex-shrink-0 mt-2">
                {govukData.socialMedia.map((s, i) => (
                  <a
                    ...
                    className="text-[10px] uppercase tracking-[0.15em] px-2 py-1 bg-[#0f1a0f] text-gray-200 rounded-sm border border-[#1a2e1a] hover:text-white hover:border-[#4a7a3a] transition-colors"
                  >
          ...
          <div ref={searchRef} className="bg-[#0f1a0f] p-5 relative">
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-[#0a140a] border border-[#1a2e1a] rounded-sm px-4 py-2.5 text-white text-[13px] placeholder:text-gray-200 focus:outline-none focus:border-[#4a7a3a] transition-colors"
              />
              {zoneSearch && (
                <button
                  ...
                  return (
                    <button
                      ...
                      className={
                        ...
                        (activeZone === zone ? 'text-[#4a7a3a] bg-[#111827]' : 'text-gray-200 hover:bg-[#111827] hover:text-white')
                      }
                    >
                      {zone}
              ...
              {govukData.childOrgs.map((org, i) => {
                ...
                return (
                  <Link
                    ...
                    className="text-[12px] uppercase tracking-[0.15em] text-gray-200 hover:text-[#4a7a3a] transition-colors"
                  >
  ...
  return (
    <div className="mb-8">
      ...
      <ul className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-[#1a2e1a] border border-[#1a2e1a]">
        {people.map((person, i) => (
          <li key={i} className="bg-[#0f1a0f] p-3 border-l-2 border-l-transparent hover:border-l-[#4a7a3a] hover:bg-[#111827] transition-colors">
            <Link href={`/people/${person.slug}`} className="block">
              <p className="text-white text-[13px] font-semibold hover:text-[#4a7a3a] transition-colors">{person.name}</p>
