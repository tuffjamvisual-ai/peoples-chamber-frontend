    ...
    return (
      <div className="min-h-screen bg-[#0a0f1a] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-[#9ca3af] text-[10px] uppercase tracking-[0.25em] mt-6">Loading bill…</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-[#0a0f1a] text-white flex items-center justify-center">
        <div className="bg-[#0d1520] border border-[#1e2a3a] border-l-2 border-l-[#f87171] p-6 max-w-md">
          ...
          <p className="text-[#9ca3af] text-[13px] leading-[1.7] mb-4">{error || 'Bill not found'}</p>
          <button
    ...
    <div className="min-h-screen bg-[#0a0f1a] text-white">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
              ...
              <div className="bg-[#0d1520] p-5 border-l-2" style={{ borderLeftColor: SUCCESS }}>
                ...
                <ul className="space-y-2">
                  {((() => {
                    ...
                    <li key={i} className="flex gap-2 text-[13px] text-[#9ca3af] leading-[1.7]">
          ...
          <section className="bg-[#0d1520] border border-[#1e2a3a] border-l-2 border-l-[#60a5fa] p-5 mb-8">
            ...
            <div className="flex items-center gap-4">
              {bill.sponsor_photo ? (
                ...
                <div className="w-12 h-12 rounded-full bg-[#111827] flex items-center justify-center text-[10px] uppercase tracking-wider text-[#9ca3af]" style={{ border: `1px solid ${ACCENT}` }}>
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  {bill.sponsor_constituency && (
                    <span className="text-[11px] text-[#4b5563] font-mono">{bill.sponsor_constituency}</span>
                  )}
                </div>
              </div>
            </div>
        ...
        <section className="bg-[#0d1520] border border-[#1e2a3a] p-6 mb-8">
          ...
          <div className="mb-4">
            <div className="flex justify-between text-[10px] uppercase tracking-[0.2em] text-[#9ca3af] mb-1.5 font-mono">
                ...
                <div className="flex items-center gap-3 pt-4 border-t border-[#1e2a3a]">
                  ...
                  <div className="flex-1 flex items-center justify-between">
                    ...
                    {royalAssent.stageSittings[0]?.date && (
                      <span className="text-[11px] text-[#4b5563] font-mono uppercase tracking-[0.15em]">
        ...
        {bill.description && bill.description !== bill.title && (
          <details className="bg-[#0d1520] border border-[#1e2a3a]">
            <summary className="px-6 py-4 cursor-pointer hover:bg-[#111827] transition-colors text-[12px] uppercase tracking-[0.2em] font-semibold text-white">
              ...
              <span className="text-[#4b5563] text-[11px] ml-2 normal-case tracking-normal">(click to expand)</span>
            </summary>
            <div className="px-6 pb-6">
              <p className="text-[#9ca3af] text-[13px] leading-[1.7] whitespace-pre-wrap">{bill.description}</p>
            </div>
          </details>
        )}
      </main>
