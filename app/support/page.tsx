export default function SupportPage() {
  return (
    <div className="min-h-screen bg-[#0a140a] text-white p-8">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-8">Support</h1>
        
        <h2 className="text-xl font-bold mt-6 mb-3">Contact Us</h2>
        <p className="text-gray-300 mb-4">Email: tuffjamvisual@gmail.com</p>

        <h2 className="text-xl font-bold mt-6 mb-3">Frequently Asked Questions</h2>
        
        <h3 className="font-bold mt-4 mb-2 text-[#4a7a3a]">How does voting work?</h3>
        ...
        <h3 className="font-bold mt-4 mb-2 text-[#4a7a3a]">Where does the data come from?</h3>
        <p className="text-gray-300 mb-4">
          All bill and MP data comes from official UK Parliament APIs at parliament.uk
        </p>

        <h3 className="font-bold mt-4 mb-2 text-[#4a7a3a]">Can I change my vote?</h3>
        <p className="text-gray-300 mb-4">
          No, votes are final once submitted to maintain data integrity.
        </p>

        <h3 className="font-bold mt-4 mb-2 text-[#4a7a3a]">Is this official?</h3>
        <p className="text-gray-300 mb-4">
