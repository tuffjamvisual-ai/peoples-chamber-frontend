  ...
  return (
    <main className="home-stage">
      <div className="home-shell">
        ...
        {/* Masthead — clicks the logo / wordmark, links home */}
        ...
        {/* Hero buttons only — NOT the whole hero area */}
