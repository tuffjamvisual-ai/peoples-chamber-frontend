...
const colStyle = (left: string, width: string): CSSProperties => ({ ...card, top: '83%', left, width, height: '14%', alignItems: 'flex-start' });
...
export default function HomePage() {
  const HomeFront = (
    <>
      ...
      <a href="/expenses" className="no-hover-scale" style={{ ...card, top: '83%', left: '6%', width: '27%', height: '15%', alignItems: 'flex-start' }}>
      ...
      <a href="/departments" className="no-hover-scale" style={{ ...card, top: '83%', left: '68%', width: '26%', height: '15%', alignItems: 'flex-start' }}>
        <div style={{ width: '100%', marginBottom: '4%', position: 'relative' }}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            src="/whitehall.webp"
