  ...
  return (
    <div className="min-h-screen bg-[#0a0f1a] text-gray-200">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 pb-16">
        <Link href="/" className="inline-flex items-center gap-2 text-[#9ca3af] hover:text-white mb-8 text-sm">
          ← Home
        </Link>
        ...
        {row.summary && (
          <p className="text-base sm:text-lg text-gray-300 leading-relaxed mb-10 pl-4 border-l-2" style={{ borderColor: ACCENT }}>
            {row.summary}
          </p>
        )}

        {row.full_content ? (
          <article className="text-gray-300 text-sm sm:text-base leading-relaxed whitespace-pre-line">
            {row.full_content}
          </article>
        ) : (
          <div className="border-t border-[#1e2a3a] pt-8 mt-8">
