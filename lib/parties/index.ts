...
export const parties: Party[] = [
  ...
  { id: 'labour-coop', name: 'Labour (Co-op)', colour: '#d50000', textColour: '#ffffff', leader: 'Keir Starmer', description: 'Centre left governing party. Labour MPs additionally affiliated with the Co-operative Party, a longstanding sister party of Labour representing the cooperative movement.', hasMP: true },
