...
async function regenerateCurrent() {
  console.log('=== REGENERATING CURRENT SESSION BILLS (Session 39) ===\n');
  ...
  console.log('Total current session bills: ' + allBills.length + '\n');
...
regenerateCurrent().catch(console.error);
