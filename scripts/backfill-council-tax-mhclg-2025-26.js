#!/usr/bin/env node
// Updated MHCLG council tax pull for 2025-26 figures. The 2025-26
// publication consolidated all per-class tables into a single ODS
// (Tables_1-9_2025-26.ods) and renumbered the per-authority sheets:
// what was Tables 7a/7b/7c last year is now Tables 8a/8b/8c.
//
// Overwrites council_tax_band_d_pounds on existing rows (the 2024-25
// pass populated 315/317 English councils; this pass refreshes them
// to the current financial year and picks up any new authorities
...
const URL = 'https://assets.publishing.service.gov.uk/media/69e88e1c9ca985145673b7f4/Tables_1-9_2025-26.ods';
const SHEETS = ['Table_8a', 'Table_8b', 'Table_8c'];  // London boroughs / Shire counties / Districts
...
(async () => {
  ...
  console.log(`Fetching MHCLG Tables_1-9_2025-26.ods…`);
  ...
  console.log(`\nDone. ${updated} council tax values written for 2025-26.`);
})();
